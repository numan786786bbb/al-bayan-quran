...
export default function AllahNameDetailScreen() {
  ...
  const { name } = route.params as { name: AllahName };
  ...
  useEffect(() => {
    ...
    analytics.trackScreenView(`Allah Name Detail: ${name.transliteration}`);
  ...
  const handleShare = async () => {
    try {
      ...
      analytics.trackFeatureUsage('Share Allah Name');
    } catch (error) {
      console.error('Error sharing Allah name:', error);
    }
  };
    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <View style={styles.titleContainer}>
          ...
          <Text style={styles.numberLabel}>Name {name.number} of 99</Text>
        </View>
      ...
      <ScrollView style={styles.scrollView}>
        <View style={styles.nameContainer}>
          ...
          <Image
            source={{ uri: `https://api.a0.dev/assets/image?text=islamic%20calligraphy%20of%20${name.transliteration}%20with%20floral%20ornaments&aspect=16:9` }}
          ...
          <View style={styles.whenToReciteContainer}>
            ...
            <Text style={[styles.whenToReciteText, { fontSize: translationFontSize }]}>
              The beautiful names of Allah can be recited at any time. They can be incorporated into your daily dhikr, during salah, or in times of need. Many scholars recommend reciting specific names for different situations.
            </Text>
          </View>
